...
const CartVoucherModal = () => {
  ...
  return (
    <dialog className="cart-voucher-modal" ref={ModalRef}>
      <div className="bg-[white] h-[100%] w-[100%] p-[20px] rounded-[20px]">
            ...
            {VoucherAvail.map((item, i) => (
              <div className="cart-container-item-map" key={i}>
                ...
                <div className="cart-container-map-info">
                  ...
                  <button
                    onClick={() =>
                      handleUseVoucher(item.discount, item.shipping)
                    }
                  >
                    use
                  </button>
        ...
        <button className="cart-modal-close" onClick={handleModalClose}>
          Close
        </button>
        {VoucherAvail.length === 0 && (
          <button
            className="cart-modal-claim-voucher"
